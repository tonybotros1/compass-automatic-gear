...
import '../../../../Controllers/Main screen controllers/batch_payment_process_controller.dart';
import '../../../../Models/batch_payment_process/batch_payment_process_model.dart';
import '../../../../Models/dynamic_boxes_line_model.dart';
import '../../../../Widgets/dynamic_boxes_line.dart';
import '../../../../Widgets/main screen widgets/auto_size_box.dart';
import '../../../../Widgets/main screen widgets/batch_payment_process_widgets/batch_dialog.dart';
import '../../../../Widgets/my_text_field.dart';
import '../../../../consts.dart';

class BatchPaymentProcess extends StatelessWidget {
  const BatchPaymentProcess({super.key});
                              ...
                              Row(
                                ...
                                children: [
                                  myTextFormFieldWithBorder(
                                    width: 150,
                                    labelText: 'Batch NO.',
                                    controller: controller.batchNumberFilter,
                                  ),
                                  myTextFormFieldWithBorder(
                                    width: 400,
                                    labelText: 'Note',
                                    controller: controller.batchNoteFilter,
                                  ),
                                ],
                              ),
                              Row(
                          ...
                          child: dynamicBoxesLine(
                            dynamicConfigs: [
                              DynamicBoxesLineModel(
                                ...
                                value: '${controller.numberOfBatches.value}',
...
Widget tableOfScreens({
  ...
  required RxList<BatchPaymentProcessModel> data,
...
DataRow dataRowForTheTable(
  BatchPaymentProcessModel docData,
    ...
    cells: [
      ...
      DataCell(
        textForDataRowInTable(
          text: docData.batchNumber ?? '',
          formatDouble: false,
        ),
      ),
      DataCell(textForDataRowInTable(text: textToDate(docData.batchDate))),
      DataCell(
        statusBox(
          docData.status ?? '',
          hieght: 35,
...
class ConverterDataSource extends DataTableSource {
  final List<BatchPaymentProcessModel> cards;
  final BuildContext context;
  final BoxConstraints constraints;
  final BatchPaymentProcessController controller;
