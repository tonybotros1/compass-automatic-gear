...
import '../../../../Widgets/main screen widgets/leave_types_widgets/leave_types_dialog.dart';
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          return Padding(
            ...
            child: Column(
              children: [
                GetBuilder<LeaveTypesController>(
                  init: LeaveTypesController(),
                  builder: (controller) {
                ...
                Expanded(
                  child: Container(
                    ...
                    child: GetX<LeaveTypesController>(
                      builder: (controller) {
                        return SizedBox(
                          width: constraints.maxWidth,
...
DataRow dataRowForTheTable(
  ...
  String employeeId,
  LeaveTypesController controller,
  int index,
) {
  return DataRow(
    cells: [
      ...
      DataCell(textForDataRowInTable(text: data.type ?? '', maxWidth: null)),
      DataCell(
...
class CardDataSourceForEmployees extends DataTableSource {
  ...
  final LeaveTypesController controller;
