...
import '../../Widgets/Dashboard Widgets/job cards dashboard widgets/cashflow_summary_table.dart';
                                  ...
                                  GetX<JobCardsDashboardController>(
                                    builder: (controller) {
                                      return CustomDropdown(
                                        ...
                                        onOpen: () {
                                          return controller.getJobsDate('day');
                                        },
                                      );
                                    },
                                  ),
                                        ...
                                        return CustomDropdown(
                                          ...
                                          onChanged: (key, value) {
                                            controller
                                                    ...
                                                    .text =
                                                value['date'];
                                            controller.getCashflowDialySummary(
                                              value['date'],
                                            );
                                          },
                                          onDelete: () {
                                          ...
                                          onOpen: () {
                                            return controller.getCashflowDate();
                                          },
                                        );
                                      },
                                    ),
