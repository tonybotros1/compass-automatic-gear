import 'package:datahubai/Models/job%20cards/internal_notes_model.dart';
            ...
            Expanded(
              child: SizedBox(
                ...
                child: GetX<JobCardController>(
                  builder: (context) {
                    if (controller.isJobInternalNotesLoading.isTrue) {
                      return Center(child: loadingProcess);
                    }

                    if (controller.allInternalNotes.isEmpty &&
                        controller.isJobInternalNotesLoading.isFalse) {
                      return const Center(
                        child: Text(
                          "Empty",
                    ...
                    List<InternalNotesModel> items =
                        controller.allInternalNotes;
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        InternalNotesModel note = items[index];
                        bool isUserNote =
                            note.isThisUserIsTheCurrentUser ?? false;
