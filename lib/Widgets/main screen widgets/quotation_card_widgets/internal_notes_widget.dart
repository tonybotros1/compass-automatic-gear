            ...
            Expanded(
              child: SizedBox(
                ...
                child: GetX<QuotationCardController>(
                  builder: (context) {
                    if (controller.isQuotationInternalNotesLoading.isTrue) {
                      return Center(child: loadingProcess);
                    }

                    if (controller.allInternalNotes.isEmpty &&
                        controller.isQuotationInternalNotesLoading.isFalse) {
                      return const Center(
                        child: Text(
                          "Empty",
                                          ...
                                          : InkWell(
                                              onTap: () {
                                                ...
                                                openFile.openFile(
                                                  note.note ?? '',
                                                  '',
                                                ); // need to add the file name here
                                              },
                                              child: Row(
                                                mainAxisAlignment:
