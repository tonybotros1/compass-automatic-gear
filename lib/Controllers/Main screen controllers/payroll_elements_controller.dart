...
class PayrollElementsController extends GetxController {
  ...
  RxMap functions = RxMap({
    '01': {'name': 'PY_INPUT_VALUE_FF'},
    '02': {'name': 'PY_ANNUAL_LEAVE_FF'},
    '03': {'name': 'PY_UNPAID_LEAVE_FF'},
    '04': {'name': 'PY_SICK_LEAVE_FF'},
    '05': {'name': 'PY_MATERNITY_LEAVE_FF'},
    '06': {'name': 'PY_COMPASSIONATE_LEAVE_FF'},
    '07': {'name': 'PY_ANNUAL_LEAVE_ENTITLEMENT_FF'},
    '08': {'name': 'PY_PATERNITY_LEAVE_FF'},
    '09': {'name': 'PY_OVERTIME_NORMAL_FF'},
